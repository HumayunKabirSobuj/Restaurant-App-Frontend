...
export default function Footer() {
  ...
  return (
    <footer className="bg-red-800 text-white lg:mt-10 mt-5">
      ...
      <div>
        <div className=" mx-auto py-4 bg-[#A52A2A]  w-full ">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center text-sm text-red-100 space-y-2 md:space-y-0">
